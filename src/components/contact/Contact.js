...
const Contact = (props) => {
    ...
    const InputContainer = (props) => {
        ...
        const sendMail = (name, email, message) => {
            ...
            window.Email.send({
                Host : "smtp.gmail.com",
                Username: 'keenetan.2005@gmail.com',
                Password: process.env.REACT_APP_EMAIL_PASSWORD,
                To : 'keenetan.2005@gmail.com',
                From: 'keenetan.2005@gmail.com',
        ...
        return (
            <div style={styles['selfDescription']}>
                ...
                <div style={styles['imagesContainer']}>
                    <input onClick={() => { redirect('https://www.linkedin.com/in/keene-tan-b0a584232/') }} style={styles['image']} type='image' src={linkedin} alt=''/>
                    <input onClick={() => { redirect('https://github.com/keenetan') }} style={styles['image']} type='image' src={github} alt=''/>
